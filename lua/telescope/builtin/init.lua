...
---@param opts table: options to pass to the picker
---@field jump_type string: how to goto type definition if there is only one, values: "tab", "split", "vsplit", "never"
builtin.lsp_type_definitions = require_on_exported_call("telescope.builtin.lsp").type_definitions
